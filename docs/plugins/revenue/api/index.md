...
- **[Events](../../flows/api/index.md)** - Define purchase events
- **[Drill](../../drill/api/index.md)** - Analyze event data in detail
- **[Data Manager](../../data-manager/api/index.md)** - Configure event properties
